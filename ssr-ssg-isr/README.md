...
## SSR - Static Side Generation

Any content does not have network calls is a static page by default
...
...
However, there are exceptions , fetch requests are not caches when :
